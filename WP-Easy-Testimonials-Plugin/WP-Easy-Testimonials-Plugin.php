<?php
/*
Plugin Name: WP Easy Testimonials Plugin
Plugin URI: https://wordpress.org/plugins/Wp-Easy-Testimonials-Plugin
    ...
    <div class="testimonial-content">
      <div class="testimonial-profile">
        ...
        <span class="post"><?php echo get_post_meta( get_the_ID(), 'testi_desig', true ); ?></span> </div>
                        <ul class="rating">
        <?php
                          $_client_review = get_post_meta( get_the_ID(), 'testi_rating', true );
...
function wpetp_testimonial_shortcode() {
    add_shortcode( 'WPETP_TESTIMONIAL', 'wpetp_testimonial_loop' );
}
